...
/**
 * This program will receive file requests from a user, and 
 * sends back the requested file as a stream of bytes.  The
...
public class multithreadWebServer {
 ...
 /**
  * This method receives an active connection and manages the comumication with the 
  * client. It will check for any error and send status codes as well
  * @param connection the connected socket that will be used to
  *    communicate with the client.
  */
 private static void handleConnection(Socket connection) {
                        
                String httpRootDir = "/Documents/";
  client = connection;
                try {
   ...
   System.out.println("Connection closed.");
        ...
        // Sending the file to the output Socket as a byte stream.
        ...
        // Create a Thread thats helps us create as many sockets as there are client requests.
